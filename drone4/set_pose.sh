...
sed -i "s#<x_0> .* </x_0>#<x_0> $1 </x_0>#g" robot_localization.xml
...
sed -i "s#<z_0> .* </z_0>#<z_0> $3 </z_0>#g" robot_localization.xml
...
sed -i "s#<yaw_0> .* </yaw_0>#<yaw_0> $4 </yaw_0>#g" robot_localization.xml
